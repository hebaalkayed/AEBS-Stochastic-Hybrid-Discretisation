...
\begin{document}
	...
	\end{itemize}
	The IMDP represents the set of all MDPs over $\hat S$ and $\hat U$ whose exact transition probabilities lie within the corresponding bounds and whose transition probabilities out of each state and action sum to one.
